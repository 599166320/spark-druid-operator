...
package com.julianjaffe.spark_druid_connector.v2

import com.julianjaffe.spark_druid_connector.configuration.Configuration
import com.julianjaffe.spark_druid_connector.v2.reader.DruidDataSourceReader
import com.julianjaffe.spark_druid_connector.v2.writer.DruidDataSourceWriter
...
class DruidDataSourceV2 extends DataSourceV2 with ReadSupport with WriteSupport with DataSourceRegister
  with Logging {
