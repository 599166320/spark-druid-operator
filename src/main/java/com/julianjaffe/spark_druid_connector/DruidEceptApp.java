...
public class DruidEceptApp {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("bb count:"+dataset.count());
        dataset.show();


       /* properties.put( "table" , "bb02");
        Dataset bb02 = sparkSession.read().format("druid").options(properties).load();
        System.out.println("bb02 count:"+bb02.count());

        Dataset newdata = bb.except(bb02);
